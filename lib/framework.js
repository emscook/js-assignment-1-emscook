...
;(function (exports) {
  ...
  var _expect = function (passed, msg, options) {
    ...
    if (passed) {
      ...
      write(logFilter('<div class="console-passed">') + successMsg + logFilter('</div>', true), true);
      correct++;
    } else {
      ...
      if (options.extraCredit) {
        ...
        write(logFilter("<div class='console-missed'>") + msg + logFilter('</div>', true), true);
        incorrect++;
      } else {
        write(logFilter("<div class='console-failed'>Test Failed: ") + msg + logFilter('</div>', true), true);
